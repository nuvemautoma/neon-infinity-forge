  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative z-10 max-w-5xl mx-auto px-6 pt-20 pb-32 text-center">
        ...
        <p className="mt-3 text-primary text-lg font-medium tracking-widest uppercase">
        ...
        <div className="mt-16 flex flex-col items-start max-w-sm mx-auto gap-3">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {features.map((f) => (
            <div key={f.title} className="glass rounded-2xl p-6 text-center hover-lift">
